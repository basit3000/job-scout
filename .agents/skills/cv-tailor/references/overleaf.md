...
Overleaf's git integration is a premium feature. It is available here through TU Ilmenau's
subscription, which grants premium at the account level — so every project Basit can open
is clonable, not just ones he owns.
