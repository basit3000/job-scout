...
export const BOARD_CATALOG = [
  ...
  },
  {
    ...
    regions: 'Germany',
    free: true,
    note: 'https://www.stepstone.de — HTML search listings. Market DE only.',
    needsGermanyMarket: true,
  },
  {
    id: 'xing',
    ...
    free: true,
    note: 'https://www.xing.com/jobs — HTML search listings. Market DE only.',
    needsGermanyMarket: true,
  },
  {
    id: 'kimeta',
    ...
    regions: 'Germany',
    free: true,
    note: 'https://www.kimeta.de — German job search engine. Market DE only.',
    needsGermanyMarket: true,
  },
  {
    id: 'heise',
    ...
    regions: 'Germany IT',
    free: true,
    note: 'https://jobs.heise.de — IT Stellenmarkt. Market DE only.',
    needsGermanyMarket: true,
  },
  {
    id: 'germantechjobs',
    ...
    apify: false,
    api: true,
    regions: 'Germany tech',
    free: true,
    note: 'https://germantechjobs.de — salary-transparent tech/IT RSS. Market DE only.',
    needsGermanyMarket: true,
  },
];
