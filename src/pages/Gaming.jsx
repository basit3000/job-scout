...
function Gaming() {
  return (
    <div className="page-enter">
      ...
      <a className="link-card" href="https://www.dotabuff.com/players/395370670" target="_blank" rel="noopener noreferrer"><i className="fas fa-gamepad"></i>Dotabuff: MeyraMax</a>
      <a className="link-card" href="https://steamcommunity.com/id/sasadkasokcasokmpo/" target="_blank" rel="noopener noreferrer"><i className="fab fa-steam"></i>Steam: MeyraMax</a>
      ...
      <a className="link-card" href="https://tracker.gg/valorant/profile/riot/butterfly%238080/overview" target="_blank" rel="noopener noreferrer"><i className="fas fa-crosshairs"></i>Valorant (smurf): butterfly #8080</a>
